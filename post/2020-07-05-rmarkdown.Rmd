...
<table width="80%" border ="1" cellspacing="1" bordercolor="red" align=center> <tr><td><div align=center> Les images ne charges pas pour l'instant. Ce sera corrigé asap :)  </div></td></tr></table>
...
![](image/post-rmarkdown/firstrmarkdown.PNG)
...
![](image/post-rmarkdown/firstrmarkdown2.PNG)
...
Lorsque vous commencez à écrire votre document markdown, il faut enregistrer le fichier dans votre répertoire. On décide de l'appeler __Premier_Rmarkdown__. Les fichiers Rmarkdown ont pour extension "__.Rmd__".  Pour compiler le document on clique sur le bouton ![](image/post-rmarkdown/knit.PNG). On obtient une sortie Html comme ceci:

![](image/post-rmarkdown/firstrmarkdown3.PNG)
...
![](image/post-rmarkdown/notebook1.png)
<br>
...
![](image/post-rmarkdown/notebook2.png)
...
![](image/post-rmarkdown/notebook3.png)
<br>
...
Dans la barre de gauche choisissez __Shiny__. Donnée un titre à votre document dans __Title__ puis __OK__
 ...
 ![](image/post-rmarkdown/mardown_shiny1.png) 

<br>

Un fichier "Untitled.Rmd" est créé. Il faut l'enregistrer puis cliquer sur ![](image/post-rmarkdown/mardown_shiny_run_doc.png).

Vous venez de créer un document interactif inclus par défaut dans R Studio.

 ![](image/post-rmarkdown/mardown_shiny2.png) 
...
Pour créer un flexdashboard, il faut aller dans __File>New file>R Markdown__. Dans la barre de gauche, cliquez sur __From Template__ puis sur __Flex Dashboard__ et __OK__. 
 ...
 ![](image/post-rmarkdown/flexdashboard.png) 

<br>
Un fichier "Untitled.rmd" est créé. Changer le titre de votre document en ligne 2 en "Mon tableau de bord". Enregistrez le puis compilez le ![](image/post-rmarkdown/knit.PNG). 

Vous devriez avoir ceci : 

 ![](image/post-rmarkdown/flexdashboard2.png) 
...
Pour créer une présentation : __File>New File> R Markdown__. Dans la barre de gauche, cliquez sur __Presentation___. Donnez-lui un nom puis __OK__.
 ...
 ![](image/post-rmarkdown/slide.png) 


Enregistrez votre fichier puis compilez. 

 ![](image/post-rmarkdown/slide1.png) 
